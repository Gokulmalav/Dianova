...
class _ResultScreenState extends State<ResultScreen>
  ...
  Color _gaugeColor() {
    switch (widget.result.riskLevel.toLowerCase()) {
      case 'low':
        return const Color(0xFF7EE8B2);
      case 'moderate':
        return const Color(0xFFFFD87A);
      case 'high':
  ...
  Widget _buildStats() {
    ...
    return Row(children: [
      _statCard('Glucose', '${i.glucose.toStringAsFixed(0)}', 'mg/dL',
          Icons.water_drop_outlined, AppTheme.dangerBg, AppTheme.danger),
      const SizedBox(width: 10),
      _statCard('BMI', i.bmi.toStringAsFixed(1), 'kg/m²',
          Icons.accessibility_new, AppTheme.infoBg, AppTheme.primary),
      const SizedBox(width: 10),
      _statCard('Age', '${i.age.toStringAsFixed(0)}', 'years',
          Icons.person_outline, AppTheme.successBg, AppTheme.success),
    ]);
  }

  Widget _statCard(String label, String val, String unit, IconData icon,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('Low',
              style: GoogleFonts.dmSans(fontSize: 10, color: AppTheme.success)),
          Text('Moderate',
              style: GoogleFonts.dmSans(fontSize: 10, color: AppTheme.warning)),
          Text('High',
              style: GoogleFonts.dmSans(fontSize: 10, color: AppTheme.danger)),
        ]),
      ]),
    );
  }
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Text(
            ...
            style: GoogleFonts.dmSans(
                fontSize: 11, color: AppTheme.warning, height: 1.4),
          ),
        ),
      ]),
    );
